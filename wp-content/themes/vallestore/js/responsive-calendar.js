...
(function() {
	...
	(function($) {
		...
		Calendar = function(element, options) {
			...
			this.weekDays = ['Dom', 'Lun', 'Mar', 'Mié', 'Jue', 'Vie', 'Sab', 'Dom'];
			this.time = new Date();
		...
		Calendar.prototype = {
			...
			addOthers: function(day, dayEvents) {
	  		...
	  		drawDay: function(lastDayOfMonth, yearNum, monthNum, dayNum, i) {
				...
				day.append($("<a>" + this.addLeadingZero(dayNum) + "</a>").attr("data-day", dayNum).attr("data-month", monthNum).attr("data-year", yearNum));
