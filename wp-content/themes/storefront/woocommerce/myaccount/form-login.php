...
<?php if ( get_option( 'woocommerce_enable_myaccount_registration' ) === 'yes' ) : ?>
	...
	<div class="col-2">
		...
		<form method="post" class="register" onsubmit="return validarPass();">
			...
			<?php if ( 'no' === get_option( 'woocommerce_registration_generate_password' ) ) : ?>
				...
				<p class="form-row form-row-wide">
					<label for="reg_password"><?php _e( 'Repetir Contraseña', 'woocommerce' ); ?> <span class="required">*</span></label>
