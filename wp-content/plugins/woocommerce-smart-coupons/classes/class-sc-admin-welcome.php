            ...
            <?php
            	$faqs = array(
            				...
            				array(
            						...
            						'ans' => sprintf(__( 'Simplest method is by installing %s plugin. If you want to keep, translated file outside this plugin, refer %s.', 'wc_smart_coupons' ), '<a href="https://wordpress.org/plugins/codestyling-localization" target="_blank">' . __( 'Codestyling Localization', 'wc_smart_coupons' ) . '</a>', '<a href="http://docs.woothemes.com/document/smart-coupons/#section-19" target="_blank">' . __( 'this article', 'wc_smart_coupons' ) . '</a>' )
            					),
            				array(
