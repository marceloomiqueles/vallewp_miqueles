...
function login_header( $title = 'Log In', $message = '', $wp_error = '' ) {
	...
	if ( is_multisite() ) {
		...
		$login_header_url   = __( 'http://store.vallenevado.com/' );
		$login_header_title = __( 'Valle Nevado' );
	}
	...
	?>
	<link href="http://store.vallenevado.com/tienda_wp/wp-content/themes/storefront/images/favicon.ico" rel="shortcut icon" type="image/vnd.microsoft.icon">
	</head>
